    ...
    <Reveal>
      <section className="px-4 py-16 sm:px-6 lg:px-10">
        <div className="mx-auto max-w-7xl">
          <div className="grid gap-8 rounded-[32px] border border-[var(--pde-border)] bg-[var(--pde-surface)] p-5 shadow-[var(--shadow-card)] sm:p-8 lg:grid-cols-[0.8fr_1.2fr] lg:p-10">
            <div>
            ...
            <AnimatedCards className="divide-y divide-[var(--pde-border)] border-t border-[var(--pde-border)] lg:border-t-0">
              {problems.map((problem) => (
                ...
                >
                  <div className="grid h-11 w-11 place-items-center rounded-full border border-[var(--pde-ink)] bg-[var(--pde-brass)] text-[var(--pde-ink)]">
