...
export function FinalCTASection() {
  ...
  return (
    <section className="px-5 pb-20 pt-8 sm:px-8 lg:px-12">
      <div className="mx-auto max-w-7xl rounded-[34px] border border-[var(--pde-ink)] bg-[var(--pde-ink)] p-8 text-white shadow-[var(--shadow-card)] sm:p-12 lg:p-16">
        <p className="text-sm font-semibold uppercase tracking-[0.18em] text-[var(--pde-brass)]">
