...
export const metadata: Metadata = {
  title: "Aviso de Privacidad · Alebrije Tech",
  description: "Aviso de privacidad y protección de datos personales de Alebrije Tech.",
...
const privacySections: LegalSection[] = [
  {
    ...
    content: [
      "Alebrije Tech (en lo sucesivo 'Alebrije Tech'), con atención inicial y remota desde Tuxtla Gutiérrez, Chiapas, México, es responsable del tratamiento de sus datos personales conforme a lo establecido en la Ley Federal de Protección de Datos Personales en Posesión de los Particulares (LFPDPPP).",
  ...
  },
  {
    ...
    content: [
      "Para llevar a cabo las finalidades descritas en el presente aviso, Alebrije Tech puede recopilar los siguientes datos personales de forma directa a través de WhatsApp, formularios web o correo electrónico:",
      ...
      "Alebrije Tech no solicita ni trata datos personales sensibles (como origen étnico, estado de salud o datos financieros sensibles a través de nuestro sitio web).",
    ],
  },
  {
    id: "finalidades",
  ...
  },
  {
    ...
    content: [
      ...
      "Alebrije Tech atenderá y responderá su solicitud en un plazo máximo de 5 días hábiles.",
    ],
  },
  {
    id: "transferencias",
  ...
  },
  {
    ...
    content: [
      "Nuestro sitio web utiliza tecnologías estándar de medición y rendimiento strictly necesarias para garantizar una navegación rápida, segura y la correcta visualización de nuestros componentes visuales y carruseles en dispositivos móviles.",
    ],
  },
];
...
export default function PrivacyPage() {
  return (
    <LegalPlaceholderPage
      ...
      subtitle="Conoce cómo Alebrije Tech resguarda, utiliza y protege la información de tu negocio y proyecto digital."
