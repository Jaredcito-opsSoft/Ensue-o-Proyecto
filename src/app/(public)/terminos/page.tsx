...
export const metadata: Metadata = {
  title: "Términos y Condiciones · Alebrije Tech",
  description: "Términos y condiciones de contratación de servicios de diseño y desarrollo en Alebrije Tech.",
...
const termsSections: LegalSection[] = [
  {
    ...
    content: [
      "El presente documento regula los términos y condiciones aplicables a la contratación de servicios de diseño web, desarrollo de experiencias digitales y soluciones tecnológicas proporcionadas por Alebrije Tech (en adelante 'Alebrije Tech').",
      "Al solicitar una cotización o contratar cualquiera de nuestros paquetes (Alebrije Web Esencial, Crecimiento, Profesional o Ensueño Momentos), el cliente acepta íntegramente los términos aquí descritos.",
    ],
  },
  {
    id: "alcance",
  ...
  },
  {
    ...
    content: [
      ...
      "3. En proyectos con pago mensual (Alebrije Web Esencial y Crecimiento), la mensualidad cubre el hospedaje, mantenimiento, actualizaciones de seguridad y el paquete de microcambios mensuales incluidos.",
  ...
  },
  {
    ...
    content: [
      ...
      "El dominio registrado a través de Alebrije Tech pertenece legalmente al cliente. En caso de solicitar la transferencia de dominio a otro proveedor, Alebrije Tech facilitará los códigos de autorización sin penalizaciones.",
    ],
  },
  {
    id: "mantenimiento",
    ...
    content: [
      "Los planes mensuales de Alebrije Web incluyen soporte técnico continuo para garantizar que el sitio se mantenga activo, rápido y seguro.",
  ...
  },
  {
    ...
    content: [
      "Alebrije Tech garantiza un 99.9% de disponibilidad en la infraestructura de hospedaje y brinda soporte directo vía WhatsApp para atender cualquier eventualidad técnica en menos de 24 horas hábiles.",
    ],
  },
];
...
export default function TermsPage() {
  return (
    <LegalPlaceholderPage
      ...
      subtitle="Conoce el marco de trabajo, garantías y condiciones operativas que aplican a los proyectos diseñados por Alebrije Tech."
