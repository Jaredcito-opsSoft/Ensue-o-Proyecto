...
export const CONTACT_CONTEXTS: Array<{
...
}> = [
  {
    ...
    label: "Alebrije Web",
    prompt:
      "Hola, conocí Alebrije Tech desde su página. Quiero información para crear o mejorar la página web de mi negocio.",
  },
  {
    id: "ensueno-momentos",
    label: "Ensueño Momentos",
    prompt:
      "Hola, conocí Ensueño Momentos desde Alebrije Tech. Estoy preparando un evento y quiero crear una experiencia digital.",
  },
  {
    id: "localpos-pilot",
    label: "Piloto LocalPOS",
    prompt:
      "Hola, conocí LocalPOS desde Alebrije Tech. Me interesa participar en el piloto para mi negocio.",
  },
  {
    id: "no-se-que-necesito",
    label: "No sé qué necesito",
    prompt:
      "Hola, conocí Alebrije Tech desde su página. Tengo una idea o problema para mi negocio, pero todavía no sé qué solución necesito.",
  },
];
...
export const ATRIA_FAQ = [
  ...
  },
  {
    ...
    answer:
      "Sí. El dominio debe registrarse a nombre del cliente. Alebrije Tech puede acompañar la configuración y administración técnica según la propuesta.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Cuando Alebrije Tech administra el hosting o mantenimiento, el servicio puede suspenderse después del periodo acordado. La condición exacta se define por escrito antes de comenzar.",
  },
  {
  ...
  {
    question: "¿Alebrije Tech crea Google Business para cualquier negocio?",
    answer:
  ...
  {
    question: "¿LocalPOS está incluido en Alebrije Web?",
    answer:
  ...
  },
  {
    ...
    answer:
      "Sí. Alebrije Tech trabaja de forma remota con negocios y proyectos de México y otros países.",
  },
  {
    question: "¿Qué proyectos no acepta Alebrije Tech?",
    answer:
